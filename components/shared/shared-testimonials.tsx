...
const testimonials = [
  {
    ...
    content: 'WAFRA shared hosting has been perfect for my small business website. The performance is excellent and support is always helpful.',
    rating: 5
  },
  {
    name: 'Michael Chen',
    ...
    content: 'I\'ve been using WAFRA for my blog for over a year. The uptime is fantastic and my site loads incredibly fast.',
    rating: 5
  },
  {
